...
load_linux(unsigned int args)
{
	...
	//
	printk("ATV: ATV Linux Loader v1.1 (http://github.com/macbian-linux/atv-bootloader)\n");
	printk("ATV: Copyright (C) 2007-2008 ATV Bootloader Team - Licensed under the GPL v2\n");
	printk("ATV: Copyright (C) 2022 DistroHopper39B\n");
	...
	*/
	...
	printk("ATV: Something went wrong but no one knows what. It's probably your fault because you are stupid.\n");
